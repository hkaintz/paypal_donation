		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#zpaypal_donation-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zpaypal_donation-display": {
								"semanticObject": "zpaypal_donation",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zpaypal_donation",
									"url": sap.ui.require.toUrl("zpaypal_donation")
								}
							}
						}
					}
